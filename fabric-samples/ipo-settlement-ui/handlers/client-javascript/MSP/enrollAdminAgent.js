...
async function enrollAdminAgent() {
    try {
        // load the network configuration
        const __dirname = path.resolve(path.dirname(''));
        const ccpPath = path.resolve('..','..','fabric-samples', 'test-network', 'organizations', 'peerOrganizations', 'org3.example.com', 'connection-org3.json');
